                ...
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body text-right">
                            <p class="fs-18 text-white mb-2">Drivers</p>
                            <span class="fs-48 text-white font-w600">{{number_format($drivers->count())}}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-info">
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body text-right">
                            <p class="fs-18 text-white mb-2">Passengers</p>
                            <span class="fs-48 text-white font-w600">{{number_format($passengers->count())}}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-success">
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body text-right">
                            <p class="fs-18 text-white mb-2">Rides</p>
                            <span class="fs-48 text-white font-w600">{{number_format($rides->count())}}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-secondary">
                <div class="card-body">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body text-right">
                            <p class="fs-18 text-white mb-2">Vehicles</p>
                            <span class="fs-48 text-white font-w600">{{number_format($vehicles->count())}}</span>
                        </div>
                    </div>
                </div>
            </div>
